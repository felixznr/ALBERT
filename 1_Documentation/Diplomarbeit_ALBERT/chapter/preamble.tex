...
\lstdefinestyle{matlabstyle}{
  ...
  basicstyle=\ttfamily\small,
  numbers=left,
  numberstyle=\footnotesize\color{codenum},
  stepnumber=1,
  numbersep=8pt,
  showstringspaces=false,
  tabsize=4,
  ...
  morekeywords={zeros,ones,eye,length,size,linspace,plot,xlabel,ylabel,title,legend,grid,hold,subplot,figure,syms,subs,double,simplify,diff,int,inv,det,disp,fprintf,ode45,ss,tf,lqr,kalman,place,eig},
  emph={pi,Inf,NaN,true,false},
  emphstyle=\color{codety}\bfseries
}
% Ende Preamble