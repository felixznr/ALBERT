...
Foto (mit Erläuterung) & \vspace{0.1cm}{\centering\includegraphics[width=0.7\linewidth]{ALBERT_assembly.jpg}\par} 3D-Modell der ALBERT-Rakete\\
\hline
\noalign{\vskip 1mm}
\hline
...
\hline
% AUSFÜLLEN: Fügen Sie hier die Bilddatei und eine kurze Bildunterschrift ein. Bilddateien sollten im gleichen Verzeichnis liegen oder mit Pfad angegeben werden.
Illustrative Graph, Photo (with explanation) & \vspace{0.1cm}{\centering\includegraphics[width=0.7\linewidth]{ALBERT_assembly.jpg}\par} 3D-Model of the ALBERT Rocket\\
\hline
\noalign{\vskip 1mm}
\hline
% NICHT AUSFÜLLEN: Geben Sie an, wo die Arbeit eingesehen werden kann (physisch und digital). Nennen Sie Ansprechpartner und ggf. Kontaktinformationen.
